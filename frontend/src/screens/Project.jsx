...
const Project = () => {
                ...
                <section className="left relative flex flex-col h-full min-w-96 bg-slate-300">
                    ...
                    <div className="conversation-area flex-grow flex flex-col overflow-hidden">
                        <div className="flex flex-col flex-grow w-full overflow-hidden">
                            <div
                                ref={messageBox}
                                className="message-box p-2 flex-grow flex flex-col gap-2 overflow-y-auto max-h-full"
                            >
                                    ...
                                    <div
                                        ...
                                        className={`p-2 rounded-md max-w-xs ${
                                            msg.sender._id === user._id
                                                ...
                                                : 'bg-slate-950 text-white self-start'
                                        }`}
                                    >
                                        ...
                                        ><Markdown
                                        className="text-sm bg-slate-950 text-white"
                                        options={{
                                          overrides: {
                                            code: {
                    ...
                    <div
                        className={`sidePanel w-96 h-full flex flex-col gap-2 bg-slate-50 absolute transition-all overflow-auto ${
  ...
  Object.keys(fileTree).map((file, index) => (
    <button 
      ...
      onClick={() => {
        setCurrentFile(file);
        setOpenFiles(prevFiles => Array.from(new Set([...prevFiles, file])));
      }}
      ...
      <p className='font-semibold text-lg'>{file}</p>
                        ...
                        <div className="code-editor flex flex-col flex-grow h-full">
                            ...
                            <button
                                ...
                                <div className="bottom flex flex-grow max-w-full shrink overflow-auto">
                                    {
                                        fileTree?.[currentFile]?.file?.contents!=null && (
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-11/12 max-w-md max-h-[80vh] overflow-auto">
